...
//missed the first class introduction so I started here------
//Every second I spend in this class gives me inescapable emotional damage
//It is not your fault I just hate coding
//we will create a variable that holds the 'weapon' that the user has
let weapon = "Fists";

//If the weapons equals Fists
//Then change the inner html of column3 to say "<p> you are using fists </p>"
//else if weapon = Ropedart
//then give a different message
//if(){}else(){}else{}

if (weapon=="Fists"){
    document.getElementById("column3").innerHTML += "<p> Current Weapon- Fists </p>"
} else if (weapon=="Ropedart"){
    document.getElementById("column3").innerHTML += "<p> Current Weapon- Ropedart </p>"
} else {
    document.getElementById("column3").innerHTML += "<p> Your Weapon dosent work here </p>"
}
...
//change the content in the third column
document.getElementById("column3").innerHTML += weapon+ " have damage of: "+damage;
