...
console.log("and thank goodness for that")
...
function storageBuild() {
    ...
    //add 1 to building variable
    buildings++; document.getElementById("city").innerHTML="You have " +buildings+" buildings in your city!";
    document.getElementById("cityGraphic").innerHTML+="<img src='images/BuildingBlock1.png' alt='Storage Unit'> </img>";
    //+= adds to exsisting everytime its clicked
}
...
function trainBuild() {
    console.log("Yay! Public Transit!")
    buildings++; document.getElementById("city").innerHTML="You have " +buildings+" buildings in your city!";
    document.getElementById("cityGraphic").innerHTML+="<img src='images/BuildingBlock2.png' alt='Train Car'> </img>";
}
...
function storeFront() {
    console.log("Care for a pastry or beverage?")
     buildings++; document.getElementById("city").innerHTML="You have " +buildings+" buildings in your city!";
    document.getElementById("cityGraphic").innerHTML+="<img src='images/BuildingBlock3.png' alt='Train Car'> </img>";
}